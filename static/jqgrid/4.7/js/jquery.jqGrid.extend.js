...
var DataGrid = function (options, $this) {
    ...
    options = $.extend({
        ...
        jsonReader: { 	// 自定义表格的JSON读取参数
            repeatitems: false, id: options.dataId, root: "records", page: "pageNo", userdata: "otherData",
            total: "totalPage", records: "count", subgrid: {root: "records"}
        },
        treeReader: {	// 自定义树表格JSON读取参数
            level_field: "level", parent_id_field: "parentId", userdata: "otherData",
            leaf_field: "isLeaf", expanded_field: "expanded", icon_field: "_icon"
        },
...
//					setParam({postData: {parentCode: postData.nodeid}});
        ...
        loadComplete: function (data) {
            ...
            if (typeof options.ajaxSuccess == 'function') {
                options.ajaxSuccess.call(this, data);
            }
